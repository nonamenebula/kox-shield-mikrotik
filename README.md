...
Смена локации без переустановки. После установки один раз:
...
Без номера команда печатает все локации и пинг до сервера. С номером переключает контейнер. Сама на запасную локацию не переходит.
